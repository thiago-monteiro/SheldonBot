...
tokenizer = AutoTokenizer.from_pretrained("bigscience/bloom", cache_dir="cached")
...
def run_model():
    ...
    new_user_input_ids = tokenizer.encode("Respond as if you are Sheldon Cooper from the Big Bang Theory: " + user_input + tokenizer.eos_token, return_tensors='pt').to(device)
